...
class CascadeFailure:
    def __init__(self, path: str, ox_path: str, strategy: AbstractStrategy, multiplier: float=1.5,init=True):
        self.path = path
    ...
    def create_image(self, save=False, filepath=None, show=False):
        ...
        node_colors = {}
        colors[0] = (colors[0][0], colors[0][1], colors[0][2], 0.1)
        colors[1] = (1, 0, 0, 1)
        ...
        for i, failed in enumerate(self.failed_nodes):
            ...
            ox.plot_graph(ox_graph, node_size=30, node_color=node_colors, edge_color="w", figsize=(20,20), bgcolor="k", save=save, filepath=fp, show=show)
